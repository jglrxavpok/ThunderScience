...
class GuiCreeperSolidifier(val player: EntityPlayer, val te: TileEntityCreeperSolidifier): GuiContainer(ContainerCreeperSolidifier(player, te)) {

    private val backgroundTexture = ResourceLocation(ThunderScience.ModID, "textures/gui/solidifier.png")
    private val title = TextComponentTranslation(ThunderScience.ModID+".gui.solidifier.title")
